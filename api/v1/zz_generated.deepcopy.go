...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TLSCASecretRef) DeepCopyInto(out *TLSCASecretRef) {
	*out = *in
	if in.Namespace != nil {
		in, out := &in.Namespace, &out.Namespace
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TLSCASecretRef.
func (in *TLSCASecretRef) DeepCopy() *TLSCASecretRef {
	if in == nil {
		return nil
	}
	out := new(TLSCASecretRef)
