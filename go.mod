...
replace goftp.io/server/v2 => gitea.com/rossigee/server/v2 v2.0.0-20250820085048-feeb385fa898

// Force compatible Kubernetes versions that don't have structured-merge-diff conflicts
